      ...
      <div style={s.shell}>
        ...
        <main style={s.main}>
          <header style={s.pageHeader}>
            <div>
              <h1 style={s.pageTitle}>Consola de <span style={{ color:"#00bcd4" }}>Producción</span></h1>
          ...
          <div style={s.grid}>
            {/* Inbox */}
            <section style={{ ...s.card, gridColumn:"span 5", display:"flex", flexDirection:"column", maxHeight:"calc(100vh - 160px)" }}>
            ...
            {/* Chat */}
            <section style={{ ...s.card, gridColumn:"span 7", display:"flex", flexDirection:"column", maxHeight:"calc(100vh - 160px)" }}>
              <div style={{
